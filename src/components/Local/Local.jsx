...
import {EffectCoverflow, EffectFade, Autoplay, Pagination, Navigation } from 'swiper/modules';
...
const Local = () => {
  return (
    ...
    <section className='local'>
      ...
      <motion.div initial={{ y: -50 }} animate={{ y: 0 }} transition={{ duration: 1 }} className="hero">
      <Swiper  effect={'coverflow'}
        ...
        modules={[EffectCoverflow, Pagination]}
         className="mySwiper-local">
        <SwiperSlide className='swiper-slide-local-1'>  </SwiperSlide>
        <SwiperSlide className='swiper-slide-local-2'>   </SwiperSlide>
        <SwiperSlide className='swiper-slide-local-3'>  </SwiperSlide>
        <SwiperSlide className='swiper-slide-local-4'>   </SwiperSlide>
      </Swiper>
    </motion.div>
    ...
    <motion.div initial={{ x: -50 }} whileInView={{ x: 0 }} transition={{ duration: 1 }} className='conte-img-local'>
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3292.00435820174!2d-58.64089212336877!3d-34.401235146834566!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x95bca73f7a5ecced%3A0x712d97d7877561d0!2sBahala%20Beauty!5e0!3m2!1ses!2sar!4v1691607958784!5m2!1ses!2sar"  loading="lazy" ></iframe>
          ...
          <motion.div initial={{ x: 50 }} whileInView={{ x: 0 }} transition={{ duration: 1 }} className='conte-txt-local'>
